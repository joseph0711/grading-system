...
type TeacherHomeProps = {
  ...
  courseId: string;
  onBackToSelectCourse: () => void;
};

const TeacherHome: React.FC<TeacherHomeProps> = ({ 
  onLogout, 
  courseId, 
  onBackToSelectCourse 
}) => {
          ...
          <div className="flex flex-col items-center space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 w-full max-w-4xl">
              {[
                {
                  title: "Grading",
                  description: "Grade assignments and manage student submissions",
                  icon: "📝",
                ...
                {
                  title: "Manage Course",
                  description: "Update course details and manage materials",
                  icon: "📚",
                ...
                {
                  title: "View Score",
                  description: "Review student grades and statistics",
                  icon: "📊",
