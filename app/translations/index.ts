export const translations = {
  en: {
    ...
    errorDeletingSelectedStudents: "Error deleting selected students.",
    failedToDeleteSelectedStudents: "Failed to delete selected students.",
    errorUpdatingCourseDescription: "Failed to update course description.",
    failedToUpdateCourseDescription: "Failed to update course description.",
    selectedStudentsDeleted: "Selected students deleted successfully!",
  ...
  zh: {
    ...
    gradingCriteriaError: "總權重必須等於100",
    ...
    isRequired: "必填欄位",
    loginFail: "登入失敗！",
    saveWeightsError: "保存權重時發生錯誤：",
    studentInfoUpdated: "學生資訊更新成功！",
    errorUpdatingStudent: "更新學生資訊時發生錯誤。",
    failedToUpdateStudent: "更新學生資訊失敗。",
    errorDeletingStudent: "刪除學生時發生錯誤。",
    failedToDeleteStudent: "刪除學生失敗。",
    errorDeletingSelectedStudents: "刪除所選學生時發生錯誤。",
    failedToDeleteSelectedStudents: "刪除所選學生失敗。",
